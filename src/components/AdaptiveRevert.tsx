...
export function AdaptiveRevert(props: AdaptiveRevertProps) {
  ...
  const spacingLg = `${spacing.gapY * 2}px`; // 32px typically
  const spacingSm = `${spacing.gapY * 0.5}px`; // 8px typically
  const spacingMd = `${spacing.gapY}px`; // 16px typically
  const spacingXs = `${spacing.gapY * 0.25}px`; // 4px typically
